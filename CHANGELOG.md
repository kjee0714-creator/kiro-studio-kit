...
- `--version` / `-v` CLI support to display the current version
- `--help` / `-h` CLI support
- "Try it in 1 minute" README guide for first-time users (bash + PowerShell)

### Changed

- CLI help text updated to English to reduce Windows mojibake risk

### Fixed

- Reduced risk of garbled Japanese text in Windows PowerShell help output
